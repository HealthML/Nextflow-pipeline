...
def main():
    ...
    # protein LOF variants - here is probably the connection to the VEP procedure
    ensemblvep_df = pd.read_csv('/mnt/projects/ukbiobank/derived/projects/kernels_VEP/vep_SPB_out/v2/ensembl_vep/lof_filtered.tsv', sep='\t')
    ...
    for chromosome in range(1, 23):
        ...
        # TODO: change the output directory ; changed from './results/experiments/blood_biochemistry/' -> './results/'
        output_prefix = './results/' + experiment + '/' + short_to_dir[pheno_short] + '/' + chrom_to_load
        os.makedirs(os.path.dirname(output_prefix), exist_ok=True)

        # plink file prefix
        path_to_plink_geno_files_with_prefix = '/mnt/projects/ukbiobank/derived/projects/kernels_VEP/ukb_SPB_50k_exome_seq_filtered_chr' + chrom_to_load
        ...
        path_to_covariates = '/mnt/projects/ukbiobank/derived/projects/kernels_VEP/master_thesis_pia/blood_biochemistry_phenotypes_and_covariates/blood_biochemistry_pheno_and_cov_unrelated_gaussian_quantile_transformed.csv'
