...
def get_args():
    ...
    parser.add_argument('-ukbdir', '--ukbiobankdirectory', default = '/home/Aliki.Zavaropoulou/UKbiobank', type = str)
    parser.add_argument('-g', '--geno', type = str)
...
def main():
    ...
    ensemblvep_df = pd.read_csv(ukb_dir + /seaktsv/ + args.input , sep='\t')
    ...
    path_to_plink_geno_files_with_prefix = ukb_dir + '/ukb_FE_50k_exome_seq_filtered'
    ...
    for chromosome in range(1, 23):
        ...
        output_prefix =  ukb_dir + experiment + '/' + short_to_dir[pheno_short] + '/' + chrom_to_load
